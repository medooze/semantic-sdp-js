...
class MediaInfo {
	 ...
	 * @returns {CodecInfo | undefined} codec info object
	 */
	 ...
	 * @param {DataChannelInfo | null} dataChannel info
	 */
	 ...
	 * @param {SimulcastInfo | null} simulcast - Simulcast stream info
	 */
...
MediaInfo.create = function(id,type,supported)
{
       ...
       if (!supported && typeof type != "string")
       {
	       //Reallocate params
	       // @ts-expect-error
	       supported = type;
