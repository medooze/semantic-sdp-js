...
class CodecInfo {
	 ...
	 * Get param
	 * @param {String} key
	 * @param {String} [defaultValue] default value if param is not found (if not provided and key is not present, an error is thrown)
	 * @returns {String} 
	 */
...
CodecInfo.MapFromNames = function(names,rtx,rtcpfbs)
{
	...
	for (const element of names)
	{
		...
		const [rawName, ...params] = element.split(";");
		//Get codec name from first param
